Shader "Dithering Shaders/Cutout/Diffuse" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Lambert alpha vertex:vert finalcolor:dither 
		//alphatest:_Cutoff
		...
		void dither(Input i, SurfaceOutput o, inout fixed4 color) {
			...
			//fixed4 c;
			color.a *= (GetDitherColor(color.rgb, _DitherTex, _PaletteTex,
				      _PaletteHeight, i.ditherPos, _ColorCount).r);	
			color.a *= 0.3;
